...
public class ProjectSGLogDesActivity$$ViewInjector {
  public static void inject(Finder finder, final com.henghao.parkland.activity.projectmanage.ProjectSGLogDesActivity target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624244, "field 'tvTechnicalIndex'");
    target.tvTechnicalIndex = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624245, "field 'tvWorkingCondition'");
    target.tvWorkingCondition = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624246, "field 'tvPrincipal'");
    target.tvPrincipal = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624247, "field 'tvBuilder'");
    target.tvBuilder = (android.widget.TextView) view;
  }
  ...
  public static void reset(com.henghao.parkland.activity.projectmanage.ProjectSGLogDesActivity target) {
    ...
    target.tvTechnicalIndex = null;
    target.tvWorkingCondition = null;
    target.tvPrincipal = null;
    target.tvBuilder = null;
  }
}

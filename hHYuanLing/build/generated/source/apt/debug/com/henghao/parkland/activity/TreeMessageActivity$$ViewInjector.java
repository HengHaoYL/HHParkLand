...
public class TreeMessageActivity$$ViewInjector {
  public static void inject(Finder finder, final com.henghao.parkland.activity.TreeMessageActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624358, "field 'tvTreeId'");
    target.tvTreeId = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624359, "field 'etTreeName'");
    target.etTreeName = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131624360, "field 'etTreeUse'");
    target.etTreeUse = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131624361, "field 'etTreeSpecification'");
    target.etTreeSpecification = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131624362, "field 'tvTreeSite'");
    target.tvTreeSite = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624363, "field 'tvTreeTime'");
    target.tvTreeTime = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131624364, "field 'btnSubmit' and method 'onClick'");
    ...
    view = finder.findRequiredView(source, 2131624365, "field 'btnCancel' and method 'onClick'");

...
public class YanghuMainActivity$$ViewInjector {
  public static void inject(Finder finder, final com.henghao.parkland.activity.YanghuMainActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624371, "field 'sp_State'");
    target.sp_State = (android.widget.Spinner) view;
    view = finder.findRequiredView(source, 2131624374, "field 'btnYhmanage' and method 'onClick'");
    ...
    view = finder.findRequiredView(source, 2131624373, "field 'btnTreeYh' and method 'onClick'");
    ...
    view = finder.findRequiredView(source, 2131624372, "field 'btnTreemessage' and method 'onClick'");

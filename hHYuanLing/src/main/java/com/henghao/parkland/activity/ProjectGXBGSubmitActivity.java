...
public class ProjectGXBGSubmitActivity extends ActivityFragmentSupport {
    ...
    private static final int REQUEST_IMAGE2 = 0x01;
    ...
    private void requestData() {
       ...
       /* multipartBuilder.type(MultipartBuilder.FORM)//
        ...
        for (File file : mFileList) {
            multipartBuilder.addFormDataPart("xcSituation", file.getName(), RequestBody.create(MediaType.parse("multipart/form-data"), file));//图片
        }
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ProjectGXBGSubmitActivity.this, result, Toast.LENGTH_SHORT).show();
                        }
                    });
                    finish();

...
import com.henghao.parkland.activity.ProjectSGLogDesActivity;
...
public class ProjectSGLogAdapter extends ArrayAdapter<ProjectSGLogEntity> {
    ...
    public ProjectSGLogAdapter(ActivityFragmentSupport activityFragment, List<ProjectSGLogEntity> mList) {
    ...
    private void viewClick(HodlerView mHodlerView, View convertView, final int position) {
        final ProjectSGLogEntity mentity = getItem(position);

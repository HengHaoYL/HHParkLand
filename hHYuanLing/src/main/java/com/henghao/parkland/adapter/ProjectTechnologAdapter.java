...
import com.henghao.parkland.activity.ProjectTechnologDesActivity;
...
public class ProjectTechnologAdapter extends ArrayAdapter<ProjectTechnologEntity> {
    ...
    public ProjectTechnologAdapter(ActivityFragmentSupport activityFragment, List<ProjectTechnologEntity> mList) {
    ...
    private void viewClick(HodlerView mHodlerView, View convertView, final int position) {
        ...
        final ProjectTechnologEntity mentity = getItem(position);
